	...
	public static Simulator run(boolean testing, final long endTime, String graphFile, @Nullable Display display,
		...
		simulator.addTickListener(new TickListener() {
			...
			public void printTaxiData() {
				...
				System.out.println("In case of CNet, these are the statistics: \n\t\n\tTAXI\n\t" + "Total messages: "
			...
			public void writeDataToFile() {
				...
				try {
					PrintWriter writer = new PrintWriter("CNet_results" + TEST_STOP_TIME + "ms.txt", "UTF-8");
					writer.println("CNet setup:");
